...
wget -O ${EIGEN_ZIP_PATH} "https://gitlab.com/libeigen/eigen/-/archive/3.4.0/eigen-3.4.0.zip"
unzip ${EIGEN_ZIP_PATH} -d ${ROBOGEL_CHECKOUT_DIR}/HTWKMotion/eigen/
