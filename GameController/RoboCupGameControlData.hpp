...
#define GAMECONTROLLER_TCM_HEADER "RGTD"
...
#define COMPETITION_TYPE_1VS1_CHALLENGE 4
#define COMPETITION_TYPE_PASSING_CHALLENGE 5
...
#define AUTO_CALIBRATION_PHASE_1 0

#define AUTO_CALIBRATION_PHASE_2_1 1

#define AUTO_CALIBRATION_PHASE_2_2 2

#define AUTO_CALIBRATION_PHASE_2_3 3

#define AUTO_CALIBRATION_PHASE_2_4 4

#define AUTO_CALIBRATION_PHASE_2_5 5

/* RUNSWIFT ADDITIONAL */

/**

 *  NOTE: Remember to change these strings if any of the penalty / state / phase names above change

 */

extern const char *gameControllerGamePhaseNames[4];

extern const char *gameControllerStateNames[5];

extern const char *gameControllerPenaltyNames[16];

/* END RUNSWIFT ADITIONAL */
